...
import { PdfToPdfaEngine } from "./engines/pdf-to-pdfa-engine";
import { ComparePdfEngine } from "./engines/compare-pdf-engine";
import { OcrPdfEngine } from "./engines/ocr-pdf-engine";
...
import { MemeGeneratorEngine } from "./engines/meme-generator-engine";
import { ImageColorPickerEngine } from "./engines/image-color-picker-engine";
import { FaviconGeneratorEngine } from "./engines/favicon-generator-engine";
import { HeicToJpgEngine } from "./engines/heic-to-jpg-engine";
import { ImageToTextOcrEngine } from "./engines/image-to-text-ocr-engine";
import { GifMakerEngine } from "./engines/gif-maker-engine";
import { BackgroundRemoverEngine } from "./engines/background-remover-engine";
import { ImageUpscalerEngine } from "./engines/image-upscaler-engine";
import { BlurFaceEngine } from "./engines/blur-face-engine";
import { PomodoroTimerEngine } from "./engines/pomodoro-timer-engine";
import { FlashcardMakerEngine } from "./engines/flashcard-maker-engine";
import { CitationGeneratorEngine } from "./engines/citation-generator-engine";
import { AiTextToolEngine } from "./engines/ai-text-tool-engine";
...
case "pdf-to-pdfa":    return <PdfToPdfaEngine />;
case "pomodoro-timer":   return <PomodoroTimerEngine />;
case "citation-generator": return <CitationGeneratorEngine />;
    case "flashcard-maker":  return <FlashcardMakerEngine />;
    case "pdf-compare":    return <ComparePdfEngine />;
    case "pdf-ocr":    return <OcrPdfEngine />;
    ...
    // Developer
case "meme-generator":    return <MemeGeneratorEngine />;
    case "image-color-picker":return <ImageColorPickerEngine />;
    case "favicon-generator": return <FaviconGeneratorEngine />;
case "heic-to-jpg":      return <HeicToJpgEngine />;
    case "image-to-text-ocr":return <ImageToTextOcrEngine />;
case "gif-maker":          return <GifMakerEngine />;
    case "background-remover": return <BackgroundRemoverEngine />;
    case "image-upscaler":     return <ImageUpscalerEngine />;
    case "blur-face":          return <BlurFaceEngine />;
case "ai-text-generic": return <AiTextToolEngine slug={tool.slug} />;
